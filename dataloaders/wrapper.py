...
class CacheClassLabel(data.Dataset):
    ...
    def __init__(self, dataset):
        ...
        # For Windows as it does not allow file name to have < >
        # label_cache_filename = path.join(self.dataset.root, str(type(self.dataset))+'_'+str(len(self.dataset))+'.pth')
        label_cache_filename = path.join(self.dataset.root, type(self.dataset).__name__ +'_'+str(len(self.dataset))+'.pth')
